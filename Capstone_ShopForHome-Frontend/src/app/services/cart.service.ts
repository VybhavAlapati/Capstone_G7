...
export class CartService {
    ...
    update(productInOrder): Observable<boolean> {

        if (this.currentUser) {
            const url = `${this.cartUrl}/add/${productInOrder.count}/${productInOrder.productId}`;
            // const url = `${this.cartUrl}/add`;
            
            return this.http.put<boolean>(url, productInOrder.count);
        }
